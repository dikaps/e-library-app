...
<section class="sec text-secondary-100">
  <form action="#" method="POST" autocomplete="off" class="mb-3">
    <input type="text" name="keyword" id="keyword" class="w-full bg-secondary-400 border-2 focus:border-gray-400 focus:bg-secondary-300 outline-none rounded-md px-4 py-2 text-secondary-100" placeholder="Cari Buku / Penulis / Penerbit / Kategori ..." />
  </form>
  <div class="flash-data" data-flashdata="<?= $this->session->flashdata('pesan'); ?>" data-type="<?= $this->session->flashdata('type'); ?>"></div>
