              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td nowrap>
                      <a href="<?= base_url('booking/hapusbooking/' . $t['id_buku']); ?>" onclick="return confirm('Yakin tidak Jadi Booking <?= $t['judul_buku'] ?>');"><i class="btn btn-sm btn-outline-danger fas fw fa-trash"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
